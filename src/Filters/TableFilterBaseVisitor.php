...
/**
 * This class provides an empty implementation of {@see TableFilterVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class TableFilterBaseVisitor extends AbstractParseTreeVisitor implements TableFilterVisitor
{
	/**
	 * {@inheritdoc}
	 *
